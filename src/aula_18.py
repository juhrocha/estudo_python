...
print(teste) # nesses prints é possível perceber que ambas listas ficaram iguais
print(testando)
teste.append('Reinaldo') # aqui adc elementos à primeira lista
teste.append(28)
print(teste) # ao printar aqui é possível perceber que as listas mudaram, inclusive as posições contidas nelas
print(testando)
print(teste[0])
print(testando[0])
