"""A FUNÇÃO MAP "FUNCIONA COMO UM LOOPING FOR" SÓ QUE DE MANEIRA SINTETIZADA.
ELE IRÁ EXECUTAR COM UMA FUNÇÃO + LISTA (NORMALMENTE NÚMERICA) = MAP(FUNÇÃO, LISTA) E DEVERÁ SER ESTIPULDO
